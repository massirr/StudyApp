...
- All spec-driven artifacts live under `openspec/changes/<YYYY-MM-DD-slug>/`: `proposal.md`, `design.md`, `tasks.md` (the implementation plan), and `specs/<capability>/spec.md` deltas. Published specs live in `openspec/specs/`.
