# Spec: Answer Distribution Policy

## Purpose

Prevent a predictable correct-answer pattern in the quiz by keeping the correct option letter balanced across each topic, while guaranteeing that any reordering preserves answer content and positional option ids.
