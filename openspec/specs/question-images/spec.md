# Spec: Question Images

## Purpose

Define an optional illustration on a quiz question, for exercises whose skill is describing something you can see. Alternative text is mandatory rather than optional: on a describe-the-picture question a missing alt does not degrade the experience, it removes the question.
